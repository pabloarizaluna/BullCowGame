...
BullCowGame-Linux-Debug:
	 $(PROJECTBUILD) BullCowGame Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

BullCowGame-Linux-DebugGame:
	 $(PROJECTBUILD) BullCowGame Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

BullCowGame-Linux-Shipping:
	 $(PROJECTBUILD) BullCowGame Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

BullCowGame-Linux-Test:
	 $(PROJECTBUILD) BullCowGame Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

BullCowGame:
	 $(PROJECTBUILD) BullCowGame Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

BullCowGameEditor-Linux-Debug:
	 $(PROJECTBUILD) BullCowGameEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

BullCowGameEditor-Linux-DebugGame:
	 $(PROJECTBUILD) BullCowGameEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

BullCowGameEditor-Linux-Shipping:
	 $(PROJECTBUILD) BullCowGameEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

BullCowGameEditor-Linux-Test:
	 $(PROJECTBUILD) BullCowGameEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

BullCowGameEditor:
	 $(PROJECTBUILD) BullCowGameEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
