...
unrealRootPath=/home/pabloarizaluna/git/UnrealEngine
BullCowGameRootPath=/home/pabloarizaluna/git/BullCowGame-starter-kit

gameProjectFile=/home/pabloarizaluna/git/BullCowGame-starter-kit/BullCowGame.uproject
...
include(BullCowGameSource.pri)
include(BullCowGameHeader.pri)
include(BullCowGameConfig.pri)
include(BullCowGameIncludes.pri)
include(BullCowGameDefines.pri)

BullCowGame-Linux-Debug.commands = $$build BullCowGame Linux Debug  -project="\"$$gameProjectFile\"" $$args
BullCowGame-Linux-DebugGame.commands = $$build BullCowGame Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BullCowGame-Linux-Shipping.commands = $$build BullCowGame Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BullCowGame-Linux-Test.commands = $$build BullCowGame Linux Test  -project="\"$$gameProjectFile\"" $$args
BullCowGame.commands = $$build BullCowGame Linux Development  -project="\"$$gameProjectFile\"" $$args

BullCowGameEditor-Linux-Debug.commands = $$build BullCowGameEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
BullCowGameEditor-Linux-DebugGame.commands = $$build BullCowGameEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BullCowGameEditor-Linux-Shipping.commands = $$build BullCowGameEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BullCowGameEditor-Linux-Test.commands = $$build BullCowGameEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
BullCowGameEditor.commands = $$build BullCowGameEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	BullCowGame-Linux-Debug \
	BullCowGame-Linux-DebugGame \
	BullCowGame-Linux-Shipping \
	BullCowGame-Linux-Test \
	BullCowGame \
	BullCowGameEditor-Linux-Debug \
	BullCowGameEditor-Linux-DebugGame \
	BullCowGameEditor-Linux-Shipping \
	BullCowGameEditor-Linux-Test \
	BullCowGameEditor \
